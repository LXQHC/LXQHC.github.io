// 进行 fetch 请求
fetch('https://api.76.al/api/ip/query?key=0UglC4Ex4JkTjGC3jSA0KARlah') //申请key:https://api.76.al
    .then(response => {
        if (!response.ok) {
...
function showWelcome() {
    ...
    let dist = getDistance(126.535000, 45.803199, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
